...
export default {
  ...
  account: {
    ...
    officialSignIn: "OAuth sign-in",
    officialSignInDescription: "Authorize on chatgpt.com to quickly connect your ChatGPT account.",
    localCredentials: "Credentials stay on this device",
    localCredentialsDescription: "Authentication files are stored locally to keep your account signed in.",
    accountManagement: "Manage multiple accounts",
    accountManagementDescription: "View usage and status across your ChatGPT accounts.",
    signIn: "Sign in with ChatGPT",
    waitingForAuthorization: "Waiting for authorization…",
    authorizationPendingDescription: "Please complete the ChatGPT sign-in in the system browser that's already open — the account will be added to the list automatically.",
    ...
    addedToast: "ChatGPT account {{login}} added. You can select it in a provider.",

...
export default {
  ...
  account: {
    ...
    waitingForAuthorization: "Waiting for ChatGPT authorization…",
    authorizationPendingDescription: "The authorization page is open in your system browser. After you sign in, your account will be added to the account list.",
